...
const Projects = () => (
    ...
    <section className="projects" id="projects">
        ...
        <ProjectCard title="Github User Search" desc="An app browses github API through user query. Built with ReactJS, deployed with Netlify." thumbnail="keyboard outline"/>
